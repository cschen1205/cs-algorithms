...
{
    public class LongestCommonPatternUnitTest
    {
        private ITestOutputHelper console;

        public LongestCommonPatternUnitTest(ITestOutputHelper console)
        {
        ...
        public void Test()
        {
            ...
            console.WriteLine(LongestCommonPattern.LongestCommonString(text, "ye strike but splintered hit"));
        }
    }
}