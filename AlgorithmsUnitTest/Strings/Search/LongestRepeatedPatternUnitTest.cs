...
{
    public class LongestRepeatedPatternUnitTest
    {
        private ITestOutputHelper console;

        public LongestRepeatedPatternUnitTest(ITestOutputHelper console)
        {
        ...
        public void Test()
        {
            ...
            console.WriteLine(LongestRepeatedPattern.Find(text));
        }
    }
}