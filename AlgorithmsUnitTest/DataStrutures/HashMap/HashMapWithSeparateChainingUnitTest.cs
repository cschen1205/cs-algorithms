...
{
    public class HashMapWithSeparateChainingUnitTest
    {
        private ITestOutputHelper console;
        public HashMapWithSeparateChainingUnitTest(ITestOutputHelper console)
        {
        ...
        {
            var map = new HashMapWithSeparateChaining<int, int>();
